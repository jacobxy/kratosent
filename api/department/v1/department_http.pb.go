...
const OperationDepartmentCreateDepartment = "/api.department.v1.Department/CreateDepartment"
const OperationDepartmentDeleteDepartment = "/api.department.v1.Department/DeleteDepartment"
const OperationDepartmentGetDepartment = "/api.department.v1.Department/GetDepartment"
const OperationDepartmentListDepartment = "/api.department.v1.Department/ListDepartment"
const OperationDepartmentUpdateDepartment = "/api.department.v1.Department/UpdateDepartment"
...
func RegisterDepartmentHTTPServer(s *http.Server, srv DepartmentHTTPServer) {
	...
	r.PUT("/v1/department", _Department_UpdateDepartment0_HTTP_Handler(srv))
	r.DELETE("/v1/department/{department_id}", _Department_DeleteDepartment0_HTTP_Handler(srv))
	r.GET("/v1/department", _Department_GetDepartment0_HTTP_Handler(srv))
	r.POST("/v1/department/list", _Department_ListDepartment0_HTTP_Handler(srv))
}
...
func (c *DepartmentHTTPClientImpl) DeleteDepartment(ctx context.Context, in *DeleteDepartmentRequest, opts ...http.CallOption) (*DeleteDepartmentReply, error) {
	...
	pattern := "/v1/department/{department_id}"
